// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to StructuresAutorisees.java instead.
...
public abstract class _StructuresAutorisees extends  EOGenericRecord {
  ...
  private static Logger LOG = Logger.getLogger(_StructuresAutorisees.class);
  ...
  public void setAcces(String value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating acces from " + acces() + " to " + value);
    }
  ...
  public void setAliasGroupe(String value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating aliasGroupe from " + aliasGroupe() + " to " + value);
    }
  ...
  public void setAutorise(Integer value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating autorise from " + autorise() + " to " + value);
    }
  ...
  public void setLibelleGroupe(String value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating libelleGroupe from " + libelleGroupe() + " to " + value);
    }
  ...
  public void setNumeroGroupe(Integer value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating numeroGroupe from " + numeroGroupe() + " to " + value);
    }
  ...
  public void setNumeroPere(Integer value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating numeroPere from " + numeroPere() + " to " + value);
    }
  ...
  public void setPersId(Integer value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating persId from " + persId() + " to " + value);
    }
  ...
  public void setTypeStruct(String value) {
    if (_StructuresAutorisees.LOG.isDebugEnabled()) {
    	_StructuresAutorisees.LOG.debug( "updating typeStruct from " + typeStruct() + " to " + value);
    }
...
, Integer persId
    ...
    StructuresAutorisees eo = (StructuresAutorisees) EOUtilities.createAndInsertInstance(editingContext, _StructuresAutorisees.ENTITY_NAME);    
		eo.setNumeroGroupe(numeroGroupe);
		eo.setPersId(persId);
    return eo;
  }

  public static NSArray<StructuresAutorisees> fetchAllStructuresAutoriseeses(EOEditingContext editingContext) {
    return _StructuresAutorisees.fetchAllStructuresAutoriseeses(editingContext, null);
  }

  public static NSArray<StructuresAutorisees> fetchAllStructuresAutoriseeses(EOEditingContext editingContext, NSArray<EOSortOrdering> sortOrderings) {
    return _StructuresAutorisees.fetchStructuresAutoriseeses(editingContext, null, sortOrderings);
  }

  public static NSArray<StructuresAutorisees> fetchStructuresAutoriseeses(EOEditingContext editingContext, EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings) {
    EOFetchSpecification fetchSpec = new EOFetchSpecification(_StructuresAutorisees.ENTITY_NAME, qualifier, sortOrderings);
    fetchSpec.setIsDeep(true);
    NSArray<StructuresAutorisees> eoObjects = (NSArray<StructuresAutorisees>)editingContext.objectsWithFetchSpecification(fetchSpec);
    return eoObjects;
  }
  ...
  public static StructuresAutorisees fetchStructuresAutorisees(EOEditingContext editingContext, EOQualifier qualifier) {
    NSArray<StructuresAutorisees> eoObjects = _StructuresAutorisees.fetchStructuresAutoriseeses(editingContext, qualifier, null);
